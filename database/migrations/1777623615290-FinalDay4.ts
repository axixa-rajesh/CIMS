...
export class FinalDay41777623615290 implements MigrationInterface {
    name = 'FinalDay41777623615290'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`students\` ADD CONSTRAINT \`FK_7d7f07271ad4ce999880713f05e\` FOREIGN KEY (\`id\`) REFERENCES \`admissions\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
